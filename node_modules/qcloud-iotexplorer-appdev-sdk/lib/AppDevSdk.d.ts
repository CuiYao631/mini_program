...
export declare class AppDevSdk extends EventEmitter {
    ...
    constructor({ getAccessToken, appKey, apiPlatform, apiRegionId, debug, apiUrl, wsConfig: { autoReconnect, disconnectWhenAppHide, connectWhenAppShow, ...wsConfig }, reporter, plugins, defaultUin, enableAccessTokenCache, }: AppDevSdkOptions);
